            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Upload Pemupukan Data</h4>
                        <a href="{{ route('rekap-pemupukan') }}" class="btn btn-sm btn-primary" role="button">Back</a>
                    </div>
