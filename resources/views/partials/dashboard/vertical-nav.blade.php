<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    {{-- <li class="nav-item">
        <a class="nav-link" aria-current="page" href="{{ route('uisheet') }}" >
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    {{-- only role admin and regional head_office can see this menu --}}
    @if (auth()->user()->user_type === 'admin' && auth()->user()->regional === 'head_office')
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('master-data.index')) }}"
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('jenis-pupuk.index')) }}"
                href="{{ route('jenis-pupuk.index') }}">
                <i class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('whatsapp.index')) }}" href="{{ route('whatsapp.index') }}">
                ...
                <span class="item-name">WhatsApp Data</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('setting.index')) }}" href="{{ route('setting.index') }}">
                <i class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
