    <x-app-layout :assets="$assets ?? []">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Halaman ini digunakan untuk mencatat aktivitas pemupukan harian di lapangan. Silakan
                                lengkapi
                                semua informasi yang diperlukan untuk memastikan data yang akurat dan lengkap. Data ini
                                akan
                            ...
                            <form class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="validationCustomUsername08" required
                                        name="jenis_pupuk" style="background-color: green; color: white;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="validationCustom12" required
                                        name="cara_pemupukan" style="background-color: green; color: white;">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary form-control" id="submit-data"
                                        type="button">Simpan
                                        Data
                                        Pemupukan</button>
                                </div>
        ...
        <script>
            ...
            function loadAfdeling(regional, kebun) {
                fetch(`/api/tbm/afdeling/${regional}/${kebun}`)
                    .then(response => response.json())
                    .then(data => {
            ...
            document.getElementById('afdeling').addEventListener('change', function() {
                ...
                fetch(`/api/tbm/blok/${regional}/${kebun}/${afdeling}`)
                    .then(response => response.json())
                    .then(data => {
            ...
            document.getElementById('blok').addEventListener('change', function() {
                ...
                fetch(`/api/tbm/detail/${regional}/${kebun}/${afdeling}/${blok}`)
                    .then(response => response.json())
                    .then(data => {
                        document.getElementById('validationCustom05').value = data.tahun_tanam;
                        document.getElementById('validationCustom06').value = data.luas_ha;
                        document.getElementById('validationCustom07').value = data.jumlah_pohon;
                        const luasBlok = parseFloat(data.luas_ha) || 0;
            ...
            document.querySelector('#submit-data').addEventListener('click', function() {
                ...
                if (form.checkValidity() && luasPemupukan <= luasBlok) {
                    ...
                    fetch(`{{ route('pemupukantbm.store') }}`, {
                            method: 'POST',
                            headers: {
