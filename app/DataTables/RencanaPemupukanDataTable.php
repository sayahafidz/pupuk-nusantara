...
class RencanaPemupukanDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'rencana-pemupukan.action')
            ->rawColumns(['action']);
    }
     ...
     *
     * @param \App\Models\RencanaPemupukan $model
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data' => 'semester_pemupukan', 'name' => 'semester_pemupukan', 'title' => 'Semester Pemupukan'],
