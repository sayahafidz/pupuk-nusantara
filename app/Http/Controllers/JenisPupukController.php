...
class JenisPupukController extends Controller
{
    ...
    public function store(MasterDataRequest $request)
    {
        ...
        $user = JenisPupuk::create($request->all());
    ...
    {
        $data = JenisPupuk::with('userProfile', 'roles')->findOrFail($id);
    ...
    {
        // dd($request->all());
        $user = JenisPupuk::with('userProfile')->findOrFail($id);
