...
class PemupukanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pemupukan.rekap-pemupukan');
    }
    ...
    public function create()
    {
        ...
        return view('pemupukan.input-pemupukan');
    }
    ...
    public function chart()
    {
        ...
        return view('pemupukan.chart-pemupukan');
    }
    ...
    public function storePemupukan(Request $request)
    {
        return response()->json([
            ...
            'data' => dd($request->all()), // This will output all the input data from the request
            'otherData' => 'example'   // Add any other data you need
        ]);
    }
}
